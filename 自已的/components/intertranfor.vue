  ...
  <div class="intertranfor">
    ...
    <ul>
      ...
      <li>
        ...
        <span class="all" @click="valss=='USDT'?num=info.number:num=info.safe_num">全部</span>
        <p class="hr"></p>
        <div>{{valss}}余额：{{valss=='USDT'?info.number:info.safe_num}}</div>
      </li>
      <li>
        <p>交易密码</p>
