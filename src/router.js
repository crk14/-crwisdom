...
export default new Router({
  routes: [
    ...
    // { path: '/changephone', name: '修改手机号', component: changephone },
	...
	// { path: '/serverspage', name: '服务器', meta: { index: 3, footShow: true }, component: serverspage },
	...
	{ path: '/find', name: '发现', component: resolve =>require(['./pages/find.vue'],resolve), },
