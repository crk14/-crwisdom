...
export default new Router({
  routes: [
    ...
    // { path: '/test', name: 'k线图',  component: resolve => require(['./components/test.vue'],resolve) },
	...
	{ path: '/intetrading3', name: '智能交易3', component: resolve =>require(['./components/intetrading3.vue'],resolve) },
	{ path: '/intetrading4', name: '智能交易4', component: resolve =>require(['./pages/intertrading4.vue'],resolve) },
	...
	{ path: '/heyue3', name: '合约量化交易3', component: resolve =>require(['./pages/heyue3.vue'],resolve) },
	{ path: '/heyue4', name: '跟随机器人', component: resolve =>require(['./pages/heyue4.vue'],resolve) },
	...
	{ path: '/shangchen', name: '商城', component: resolve =>require(['./pages/shangchen.vue'],resolve),meta: { index: 2, footShow: true } },
